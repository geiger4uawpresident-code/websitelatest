...
import { Award, History, GraduationCap, Quote } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 relative">
            ...
            <motion.div 
              ...
              className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border-8 border-white bg-gray-100"
            >
              <img
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              <div className="flex gap-4 p-4 rounded-xl bg-campaign-tan/5 border border-campaign-tan/10">
            ...
            <div className="relative p-8 bg-campaign-black rounded-2xl text-white">
