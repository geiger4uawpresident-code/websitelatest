      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {cards.map((card, idx) => (
            ...
            >
              <Card className="h-full border-2 border-campaign-tan/20 hover:border-campaign-gold/50 transition-all shadow-lg overflow-hidden group">
                <CardHeader className="pb-4">
                  <div className="mb-4 bg-campaign-tan/10 w-16 h-16 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    {card.icon}
                  </div>
